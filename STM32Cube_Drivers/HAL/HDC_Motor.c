 ...
 * @param[in]	- u8Direction: The direction of the DC Motor. Must be set as: DC_MOTOR_DIRECTION_BACKWARD,
...
{
	__HAL_TIM_SET_COMPARE(&DC_MOTOR_TIMER, DC_MOTOR_CHANNEL, u16Speed);
}

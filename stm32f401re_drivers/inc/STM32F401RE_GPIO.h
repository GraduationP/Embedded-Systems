...
typedef struct{
	...
	uint16_t	GPIO_PinMode;		 // The GPIO Pin mode for the specific pin, @ref GPIO_PINMODE_define
...
// First Nibble is the Specific GPIO Mode
// Second Nibble is for General Modes (INPUT, ANALOG, OUTPUT, AF)
// Last Nibble is for Pull-up, Pull-down (0(NO PU, PD), 1(PU), 2()PD

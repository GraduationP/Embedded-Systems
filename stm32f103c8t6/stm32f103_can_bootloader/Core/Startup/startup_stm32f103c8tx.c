...
__weak void NMI_Handler ()      {Default_Handler();}
__weak void HardFault_Handler ()      {Default_Handler();}
__weak void MemManage_Handler ()      {Default_Handler();}
__weak void BusFault_Handler ()     {Default_Handler();}
